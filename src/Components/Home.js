    ...
    <div>
      ...
      <div className='AboutPage'>
        <div className='AboutText'>
          <h1 className='AboutTextHeading'>Brief <b>introduction</b></h1>
          <p>
            Hi! I'm <b>Krishna Jain</b>, a curious developer who loves turning ideas into 
            functional, elegant, and scalable solutions.  
            I’m passionate about crafting <b>modern web applications</b> and exploring 
            <b>AI-driven systems</b> that can solve real-world problems. <br /><br />

            Outside of tech, I enjoy experimenting with new concepts, sharing knowledge, playing chess, listening to music, and spending time exploring new ideas just for fun.
            And yes, nothing fuels a great coding session better than a good cup of 
